...
namespace Basic.HrCollect.Impl
{
    internal class EmpTitleCollect : IEmpTitleCollect
    {
        ...
        {
            return this._EmpTitle.GetCompanyIds(empId);
        }
        ...
        {
            return this._EmpTitle.GetTitle(empId, deptId);
        }
        public Result[] GetEmpTitle<Result> (long empId, long companyId) where Result : class, new()
        {
            return this._EmpTitle.GetEmpTitle<Result>(empId, companyId);
        }
        ...
        {
            return this._EmpTitle.GetEmpTitle(empId, companyId);
        }
