<template>
  ...
  >
    ...
    <chioseAdvertPlace :visible="visible" :is-multiple="false" :place-id="placeId" :use-range="useRange" place-type="002" @close="visible=false" @save="savePlace" />
  </el-form>
</template>
...
export default {
  ...
  methods: {
    ...
    async reset() {
      ...
      if (res.ModuleConfig && res.ModuleConfig.RollAdvert) {
        const config = res.ModuleConfig.RollAdvert
